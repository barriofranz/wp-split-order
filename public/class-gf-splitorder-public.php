 ...
 * @subpackage Gf_Splitorder/public
 */
...
class Gf_Splitorder_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/gf-splitorder-public.css', array(), $this->version, 'all' );
